      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          <a
            ...
            className="flex items-center gap-1.5 rounded-lg bg-navy-900 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-navy-800"
          >
        ...
        <div className="border-t border-navy-200 bg-white px-6 py-4 md:hidden">
          <nav className="flex flex-col gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-2 flex items-center justify-center gap-1.5 rounded-lg bg-navy-900 px-4 py-2.5 text-sm font-medium text-white"
            >
              GitHub
            </a>
          </nav>
